...
png(paste(file, "_original.png", collapse=NULL, sep=''), width=4*600, height=2*600, res=600, pointsize=10)
par(mar=c(2,2,1,1))
...
plot(x, y[,1], type='l', col=colors[1], xlim=c(xbotlimit,1), ylim=c(0,max.y), main="Mixture component", xlab=NULL, ylab=NULL)
for (j in 2:m) {
